...
Usage:
    python test_emh_local.py <host> <username> <password>

Example:
    python test_emh_local.py https://192.168.168.168 admin secret
"""
...
_STUB_PKGS = [
    ...
    ("custom_components.ppc_smgw.gateways.emh",                       "custom_components/ppc_smgw/gateways/emh"),
    ("custom_components.ppc_smgw.gateways.emh.emhcasa",               "custom_components/ppc_smgw/gateways/emh/emhcasa"),
]
...
_CLIENT_PATH = os.path.join(BASE, "custom_components", "ppc_smgw", "gateways", "emh", "emhcasa", "emh_client.py")
